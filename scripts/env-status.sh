...
for key in PLAID_ENV PORT APP_API_KEY DEV_AUTH_ENABLED PLAID_TRANSACTIONS_ENABLED PLAID_TRANSACTIONS_LOOKBACK_DAYS PLAID_LIABILITIES_ENABLED PLAID_LIABILITIES_LINK_ENABLED; do
